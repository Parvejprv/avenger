...
// const quoteButton = document.getElementById('getRandomQoute')

function getRandomQuote() {
  const randomIndex = Math.floor(Math.random() * quotes.length);
  const quoteText = document.getElementById("quoteText");
  quoteText.innerText = quotes[randomIndex].quote;
  topicsText.innerText = quotes[randomIndex].topics;
  authorText.innerText = quotes[randomIndex].author;
  professionText.innerText = quotes[randomIndex].profession;
}
